...
namespace Hazel {
	...
	OpenGLShader::OpenGLShader(const std::string& vertexSrc, const std::string& fragmentSrc, bool fromFile)
		: m_RendererID(-1) {
	...
	void OpenGLShader::ReadFiles(const std::string& vertexPath, const std::string& fragmentPath)
	{
		// read shaders
	...
	void OpenGLShader::CompileShaders(const std::string& vertexSrc, const std::string& fragmentSrc)
	{
